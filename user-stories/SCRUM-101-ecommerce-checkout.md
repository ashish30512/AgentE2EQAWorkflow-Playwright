...
## 📖 Story Description
Implement a complete checkout flow that allows customers to:
- Review their cart  
- Enter shipping information  
- Select payment method  
- Confirm their order  

The checkout process should be intuitive, secure, and provide clear feedback at each step.
...
- AND I should see:
  ...
  - "Back Home" button to return to products page  
...
- Cart cannot be empty when proceeding to checkout  
- Order confirmation should clear the cart  
- Users can cancel checkout at any step and return to cart  
